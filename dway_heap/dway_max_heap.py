...
def increase_priority(heap, old_element, new_element):
  ''' Increase the priority of a given key
      ...
      : raise IllegalArgumentException : If the new element is smaller than the the existing one.
      : return : True iff the old element was in the heap and it is successfully updated.
  '''    
  if new_element < old_element:
    raise Exception("In max-heaps existing elements' priority can only be increased!") 
